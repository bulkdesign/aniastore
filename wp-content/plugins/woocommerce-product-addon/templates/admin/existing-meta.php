...
<table border="0" class="wp-list-table widefat plugins">
	...
	<tr>
		...
		<td><?php echo PPOM() -> simplify_meta($productmeta -> the_meta)?></td>
		...
		<td><a href="javascript:are_sure(<?php echo $productmeta -> productmeta_id?>)"><img id="del-file-<?php echo $productmeta -> productmeta_id?>" src="<?php echo PPOM() -> plugin_meta['url'].'/images/delete_16.png'?>" border="0" /></a></td>
	</tr>
	<?php 
	endforeach;
	?>
