...
<div class="wdm-vertical-cpb-layout">
    ...
    <div id="caixadepresentes" class="wdm-bundle-bundle-box" data-bundle-price = "<?php echo $product->get_price(); ?>">
    <?php
    ...
    */
    ...
    <div class="wdm_product_bundle_container_form" >
        <form name = "wdmBundleProduct" method="post" enctype="multipart/form-data" id="contactTrigger" novalidate>
            ...
            <div class="gift-message-box" id="precodokit">
            <?php
...
jQuery(function($) {
  ...
  var topOfOthDiv = $("#caixadepresentes").offset().top;
