...
class WdmCPBMobileListLayout extends WdmAbstractProductDisplay
{
    ...
    public function enqueueScripts()
    {
        ...
        wp_localize_script('wdm-cpb-mobile-list-layout-js', 'mobileListLayoutParams', array(
            ...
            'giftboxFullMsg'    => __('O seu Kit Presentes está lotado.', 'custom-product-boxes'),
            'canNotAddProduct'  => __('Outro %s não pode ser adicionado ao Kit', 'custom-product-boxes'),
            'productsAddedText' => __('Produtos no Kit.', 'custom-product-boxes'),
            'totalProductPriceText' => __('Preço Total', 'custom-product-boxes'),
        ));
