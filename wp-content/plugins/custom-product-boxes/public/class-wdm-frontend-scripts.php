            ...
            if (is_singular('product')) {
                ...
                if ($product->get_type() == 'wdm_bundle_product') {
                    ...
                    $params = array(
                        ...
                        'giftboxFullMsg'    => __('O seu Kit já está completo.', 'custom-product-boxes'),
                    );
                    ...
                    wp_localize_script(
                        ...
                        array(
                            ...
                            'quantity_text' => __("A quantidade excede o limite máximo de produtos no Kit.", "custom-product-boxes"),
                            'fill_box_text' => __("Adicione produtos no Kit para poder continuar.", "custom-product-boxes"),
